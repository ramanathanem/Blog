...
export const Octobar = () => {
  return (
    ...
    <div class="container" maxWidth="lg xs md" >
        ...
        <Link to="/novambar" className='nov'> <Button size="contained"> NOVAMBAR 15, 2023</Button></Link>
      
           </Card>
        <Card style={{marginTop:"30px"}}>

        <img src= {acure}></img>
        <Link to="/original" className=''>Original Nadi Jothidam</Link>
        <Typography variant="body2" color="text.secondary">
        Original Nadi Jothidam Nadi Jothidam, often referred to as Nadi Shastra, is an ancient and […]
        </Typography>
        <Link to="/octobar">  <Button variant="contained">Admin</Button></Link>
        <Link to="/acure" className='nov'> <Button size="contained">October 2023</Button></Link>
        </Card>
    </div>
    <div class="col-sm">
     <Card style={{marginTop:"40px"}}>
     ...
     <Typography gutterBottom variant="h5" component="div"><Link to="/acure " className='geni'>
        ...
        <Link to="/octobar">  <Button variant="contained">Admin</Button></Link>
        <Link to="/original" className='nov'> <Button size="contained">October 2023</Button></Link>
     </Card>
     <Card style={{marginTop:"30px"}}>
     <img src= {nadi}></img>
     <Typography gutterBottom variant="h5" component="div"><Link to="/originalnadi " className='geni'>
     Original Nadi Jothidam</Link>
        </Typography>

        <Typography variant="body2" color="text.secondary">
        Original Nadi Jothidam Nadi Jothidam, often referred to as Nadi Shastra, is an ancient and […]  </Typography>
